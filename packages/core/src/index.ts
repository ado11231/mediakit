...
export { checkLegibility, MIN_TEXT_FRACTION } from './check/legibility.js';
export { checkFrame } from './check/frame.js';
...
export type { RenderedFrameCheck } from './check/frame.js';
export type { TextBox } from './check/svg.js';
